import { LazyCanvas, Div, MorphLayer, Exporter } from "../src";

const canvas = new LazyCanvas({ debug: true }).create(400, 400).animated();

canvas.manager.animation.setFrameRate(60).setClear(true, 20);

...
canvas.manager.layers.add(
  ...
  new Div().setID("gradient-test").add(
    new TextLayer()
      .setText("gradient")
      .setPosition(690, 330)
      .setColor("#000")
        ...
        new MorphLayer()
          ...
          .setColor(
            new Gradient()
              ...
              .setPoints(
                {
                  x: `link-x-gradient${angle}deg-${angle * 0.1}`,
                  y: `link-y-gradient${angle}deg-140`,
                  r: 5,
                },
        ...
        new PolygonLayer()
          ...
          .setColor(
            new Gradient()
              ...
              .addStops({ offset: 0, color: "#8abfff" }, { offset: 1, color: "#8affe0" })
              .setPoints(
                { x: `link-x-polygon${count}sides-0`, y: `link-y-polygon${count}sides-70`, r: 5 },

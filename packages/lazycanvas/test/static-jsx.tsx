...
export async function run() {
  ...
  const data = {
    avatar: "https://i.pinimg.com/736x/6c/e7/df/6ce7df75d5faff92241c1d28320bfe7b.jpg",
    username: "TestUser",
  ...
  scene.load(
    <Div>
      <MorphLayer
        ...
        fillStyle={data.displayOptions.solid.bg_color}
      />
      <Path2DLayer
        path2D={
          new Path2D(
        ...
        fillStyle={data.displayOptions.solid.first_component}
        transform={{
          translate: { x: 0, y: 25 },
        }}
      ...
      <Path2DLayer
        ...
        fillStyle={data.displayOptions.solid.second_component}
        transform={{
          translate: { x: 0, y: 35 },
        }}
      ...
      <Path2DLayer
        ...
        fillStyle={data.displayOptions.solid.third_component}
        transform={{
          translate: { x: 30, y: 50 },
        }}

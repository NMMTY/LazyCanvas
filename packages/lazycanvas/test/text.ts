...
const canvas = new LazyCanvas().create(800, 800);

// Reference line - center of canvas
canvas.manager.layers.add(
  new MorphLayer().setPosition("50%", 0).setSize(2, 400).setColor("#ff0000"),
);
...
const text1 =
  "This is a long text that will span multiple lines and have different colors applied to different parts of the text";
canvas.manager.layers.add(
  new TextLayer()
    .setText(text1)
    .setPosition(20, 300)
...
const text3 =
  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam venenatis et nulla sit amet aliquam.";
canvas.manager.layers.add(
  new TextLayer()
    .setText(text3)
    .setPosition(780, 570)

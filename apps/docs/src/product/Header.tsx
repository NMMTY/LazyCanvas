  ...
  return (
    <>
      <Fade
        ...
        left="0"
      />
      <Flex as="header" horizontal="center" position="sticky" top="8" zIndex={9} fillWidth vertical="center" paddingY="12" paddingX="l">
        <Row maxWidth={layout.header.width} vertical="center" horizontal="between" gap="l">
          <Row fillWidth vertical="center" gap="8">
            ...
            <Logo className="dark-flex" icon={'/trademark/icon-dark.svg'} size="l" href="/"/>
            <Logo className="light-flex" icon={'/trademark/icon-light.svg'} size="l" href="/"/>
          </Row>
